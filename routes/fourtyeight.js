...
router.get("/fourtyeight", (req, res) => {
    ...
    request.getAsync(fuelInst).spread((response, body) => {
        ...
        const array48 = context.one.response.responseBody[0].responseList[0].item;
        const timePeriod = [];
        const ccgt = [];
        const coal = [];
        const nuclear = [];
        ...
        for(let i = 0; i < array48.length; i++) {
            const allTotal = ((array48[i].intfr[0]) / 1000) + ((array48[i].intirl[0]) / 1000) + ((array48[i].intned[0]) / 1000) + ((array48[i].intew[0]) / 1000) + ((array48[i].oil[0]) / 1000) + ((array48[i].ocgt[0]) / 1000) + ((array48[i].other[0]) / 1000) + ((array48[i].biomass[0]) / 1000) + ((array48[i].ps[0]) / 1000) + ((array48[i].npshyd[0]) / 1000) + ((array48[i].ccgt[0]) / 1000) + ((array48[i].coal[0]) / 1000) + ((array48[i].nuclear[0]) / 1000) + (((array48[i].wind[0]) / 1000));
            const allTotalNoWind = ((array48[i].intfr[0]) / 1000) + ((array48[i].intirl[0]) / 1000) + ((array48[i].intned[0]) / 1000) + ((array48[i].intew[0]) / 1000) + ((array48[i].oil[0]) / 1000) + ((array48[i].ocgt[0]) / 1000) + ((array48[i].other[0]) / 1000) + ((array48[i].biomass[0]) / 1000) + ((array48[i].ps[0]) / 1000) + ((array48[i].npshyd[0]) / 1000) + ((array48[i].ccgt[0]) / 1000) + ((array48[i].coal[0]) / 1000) + ((array48[i].nuclear[0]) / 1000);
            const icsTotal = ((array48[i].intfr[0]) / 1000) + ((array48[i].intirl[0]) / 1000) + ((array48[i].intned[0]) / 1000) + ((array48[i].intew[0]) / 1000);
            const othTotal = ((array48[i].oil[0]) / 1000) + ((array48[i].ocgt[0]) / 1000);
            const bioTotal = ((array48[i].other[0]) / 1000) + ((array48[i].biomass[0]) / 1000);
            const hydroTotal = ((array48[i].npshyd[0]) / 1000) + ((array48[i].ps[0]) / 1000);
        ...
        const renewTotalCumul = totalRenew48NoWind + totalSolar48 + embeddedWindCumul;
